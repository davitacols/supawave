...
const NotificationBell = () => {
  ...
  const fetchNotifications = async () => {
    try {
      const response = await fetch('https://supawave-backend-38rgk9p93-davitacols-projects.vercel.app/api/notifications/', {
        headers: {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="relative p-2 text-gray-600 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 rounded-lg"
      >
        {unreadCount > 0 ? (
